...
favorEventList = {
    ...
    ["购物"] = FavorEvent:new("shop", "周末记得带{self}去逛逛街啦~", { week = { 6, 0 } }, "商场还没开门呢……周末再来吧", 2, shopReply, nil, "买这么多东西干什么呢？好好吃饭啦……"),
    ["看日出"] = FavorEvent:new("sunrise", "早上5点，要一起去看日出吗？", 10, { hour = { 5 } }, "还没到日出的时候呢，再等等吧", 1, "春，曙为最[CQ:image,file=favor\\sunrise.png]", "日出，很漂亮呢……"),
